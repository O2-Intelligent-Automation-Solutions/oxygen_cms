...
export const queueSchedulesSchema = z.object({
  jobs: z.array(z.object({
    key: z.enum(['database-maintenance:purge-logs', 'database-maintenance:prune-check-history', 'database-maintenance:analyze-tables', 'database-maintenance:optimize-tables', 'database-maintenance:backup-database', 'system-maintenance:check-application-updates', 'system-maintenance:prune-queue-history']),
    enabled: z.boolean(),
